...
const renderizarTabla = () => {
    ...
    if (investigacionesFiltradas.length === 0) {
    ...
    const registrosPagina = investigacionesFiltradas.slice(inicio, fin);
...
const renderizarPaginacion = () => {
    ...
    const totalPaginas = Math.ceil(investigacionesFiltradas.length / REGISTROS_POR_PAGINA);
