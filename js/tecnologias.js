...
const renderizarTabla = () => {
    ...
    if (tecnologiasFiltradas.length === 0) {
    ...
    const registrosPagina = tecnologiasFiltradas.slice(inicio, fin);
...
const renderizarPaginacion = () => {
    ...
    const totalPaginas = Math.ceil(tecnologiasFiltradas.length / REGISTROS_POR_PAGINA);
