...
const renderizarTabla = () => {
    ...
    const registrosPagina = producionFiltrada.slice(inicio, fin);
...
const renderizarPaginacion = () => {
    ...
    const totalPaginas = Math.ceil(producionFiltrada.length / REGISTROS_POR_PAGINA);
...
const crearModalAgregar = () => {
    ...
    modalBody.innerHTML = `
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="descripcion" rows="3" placeholder="Describe el tipo de producción..."></textarea>
        </div>
    `;
